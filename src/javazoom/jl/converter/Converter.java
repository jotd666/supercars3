...
public class Converter
{
	...
	public void convert(String sourceName, String destNamep,
		ProgressListener progressListener, Decoder.Params decoderParams)
		throws JavaLayerException
	{
		String destName = destNamep;
	...
	public synchronized void convert(InputStream sourceStream, String destName,
		ProgressListener progressListenerp, Decoder.Params decoderParams)
		throws JavaLayerException
	{
		ProgressListener progressListener = progressListenerp;
