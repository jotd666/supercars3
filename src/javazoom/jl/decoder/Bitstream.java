...
public final class Bitstream implements BitstreamErrors
{
  ...
  //private int				last_frame_number;
	 ...
	 */
	public Bitstream(InputStream inp)
	{
		InputStream in = inp;
	...
	public InputStream getRawID3v2()
	{
		...
		if (rawid3v2 != null)
		{
			bain = new ByteArrayInputStream(rawid3v2);		
		}
			return bain;
	}
  ...
  public int get_bits(int number_of_bits)
  {
	 ...
	 */
	private int readFully(byte[] b, int offsp, int lenp)
	 ...
	 * EOF is reached.
	 */
	private int readBytes(byte[] b, int offsp, int lenp)
		throws BitstreamException
	{
